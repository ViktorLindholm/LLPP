...
void Ped::Model::updateHeatmap(IMPLEMENTATION implementation) {
	if (implementation == OMP)
	{
		...
		int d_w[25] = {1, 4, 7, 4, 1, 4, 16, 26, 16, 4, 7, 26, 41, 26, 7, 4, 16, 26, 16, 4, 1, 4, 7, 4, 1};

		updateheatmapCUDA(d_w, d_blurred_heatmap, d_heatmap, d_scaled_heatmap, *heatmap, *scaled_heatmap, *blurred_heatmap, xDesired, yDesired, agents.size());
	/*
...
void Ped::Model::updateHeatmapSeq()
{
	...
	//updateheatmapCUDA(*heatmap, *scaled_heatmap, xDesired, yDesired, agents.size());
